 ...
 */
public class IntroTextFragment extends QuestionFragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_intro_text, container, false);
        initUI();
        return mView;
    }
    ...
    public Question getQuestion() {
        ...
        return new IntroTextQuestion("", title, "", "");
    }
}
