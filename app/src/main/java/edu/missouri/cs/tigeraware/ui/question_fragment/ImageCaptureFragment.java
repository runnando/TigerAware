...
import edu.missouri.cs.tigeraware.model.ImageCaptureQuestion;
 ...
 */
public class ImageCaptureFragment extends QuestionFragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_image_capture, container, false);
        initUI();
        return mView;
    }
    ...
    public Question getQuestion() {
        ...
        throw new RuntimeException("Image Capture question is not implemented!");
