 ...
 */
public class YesOrNoFragment extends QuestionFragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_yes_or_no, container, false);
        initUI();
        return mView;
    }
    ...
    public Question getQuestion() {
        ...
        return new YesOrNoQuestion("", title, "", "");
    }
}
