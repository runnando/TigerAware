 ...
 */
public class ConditionalFragment extends QuestionFragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_conditional, container, false);
        initUI();
        return mView;
    }
    ...
    public Question getQuestion() {
        ...
        throw new RuntimeException("Conditional question is not implemented!");
